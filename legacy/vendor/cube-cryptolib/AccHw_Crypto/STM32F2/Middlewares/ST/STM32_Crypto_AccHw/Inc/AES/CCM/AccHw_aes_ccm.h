...
#ifndef __CRL_AccHw_AES_CCM_H__
#define __CRL_AccHw_AES_CCM_H__
...
extern "C"
{
  ...
  *   precomputed tables, according the the defined value of AccHw_CRL_GFMUL in config.h */
  typedef struct
  {
    ...
    uint32_t   mContextId;
    /** 32 bit mFlags, used to perform keyschedule, choose betwen hw/sw and future use */
  ...
  int32_t  AccHw_AES_CCM_Encrypt_Init(AccHw_AESCCMctx_stt *P_pAESCCMctx, const uint8_t *P_pKey, const uint8_t *P_pNonce);

  /* Header Processing Function */
  int32_t  AccHw_AES_CCM_Header_Append(AccHw_AESCCMctx_stt *P_pAESCCMctx,
                                       const uint8_t *P_pInputBuffer,
                                       int32_t        P_inputSize);

  /* launch crypto operation , can be called several times */
  int32_t  AccHw_AES_CCM_Encrypt_Append (AccHw_AESCCMctx_stt *P_pAESCCMctx,
                                         const uint8_t *P_pInputBuffer,
                                         int32_t        P_inputSize,
  ...
  int32_t  AccHw_AES_CCM_Encrypt_Finish (AccHw_AESCCMctx_stt *P_pAESCCMctx,
                                         uint8_t       *P_pOutputBuffer,
                                         int32_t       *P_pOutputSize);

  /* load the key and ivec, eventually performs key schedule, init hw, etc. */
  int32_t  AccHw_AES_CCM_Decrypt_Init(AccHw_AESCCMctx_stt *P_pAESCCMctx, const uint8_t *P_pKey, const uint8_t *P_pNonce);

  /* launch crypto operation , can be called several times */
  int32_t  AccHw_AES_CCM_Decrypt_Append (AccHw_AESCCMctx_stt *P_pAESCCMctx,
                                         const uint8_t *P_pInputBuffer,
                                         int32_t        P_inputSize,
                                         uint8_t       *P_pOutputBuffer,
                                         int32_t       *P_pOutputSize);
  ...
  /* Possible final output */
  int32_t  AccHw_AES_CCM_Decrypt_Finish (AccHw_AESCCMctx_stt *P_pAESCCMctx,
                                         uint8_t       *P_pOutputBuffer,
                                         int32_t       *P_pOutputSize);
