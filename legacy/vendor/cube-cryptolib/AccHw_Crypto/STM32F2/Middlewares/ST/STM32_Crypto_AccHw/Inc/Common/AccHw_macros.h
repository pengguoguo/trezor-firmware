...
#else  /* AccHw_CRL_ENDIANNESS NOT SET */
#error "Please select endianness in config.h"
#endif /* #if AccHw_CRL_ENDIANNESS */


/* Support macro for rand.c for big endian cpus */
#if AccHw_CRL_ENDIANNESS==2
