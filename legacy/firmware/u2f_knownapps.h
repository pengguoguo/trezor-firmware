...
static const U2FWellKnown u2f_well_known[] = {
	{
		// WebAuthn for Binance (www.binance.com)
	...
	{
		// WebAuthn for Dropbox (www.dropbox.com)
	...
	{
		// WebAuthn for GitHub (github.com)
	...
	{
		// WebAuthn for Google (google.com)
	...
	{
		// WebAuthn for login.gov (secure.login.gov)
	...
	{
		// WebAuthn for Microsoft (login.microsoft.com)
	...
	{
		// WebAuthn for webauthn.bin.coffee (webauthn.bin.coffee)
	...
	{
		// WebAuthn for WebAuthn.io (webauthn.io)
	...
	{
		// WebAuthn for WebAuthn.me (webauthn.me)
	...
	{
		// WebAuthn for demo.yubico.com (demo.yubico.com)
